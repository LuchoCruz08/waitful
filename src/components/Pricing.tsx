    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6 mx-auto flex flex-col items-center">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Simple, Transparent Pricing</h2>
          <p className="max-w-[600px] text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Start your 14-day free trial today. No credit card required.
          </p>
        </div>
        <div className="flex items-center justify-center mt-8 w-full">
          <span className="text-sm font-medium mr-2 text-gray-400">Monthly</span>
          <Switch
            checked={isAnnual}
            ...
            <CardContent className="text-center">
              ...
              {isAnnual && (
                <p className="text-sm text-green-500 mt-2">
                  Save 20% (Equivalent to ${annualMonthlyEquivalent.toFixed(2)}/month)
                </p>
              )}
            </CardContent>
            <CardFooter className="flex flex-col space-y-4">
              <Button className="w-full hero-button">Start 14-Day Free Trial</Button>
