...
const features = [
  {
    ...
    description:
      "Create and track multiple projects in one centralized dashboard.",
    icon: CheckCircle,
  },
  {
    name: "Custom Forms",
    description:
      "Design tailored forms that capture exactly what you need from your audience.",
    icon: PenSquare,
  },
  {
    name: "Unique Share Links",
    description:
      "Generate and share unique links for each waitlist, simplifying distribution.",
    icon: Share2,
  },
  {
    name: "Export Your Data",
    description:
      "Download your waitlist data in CSV or Excel formats for easy analysis.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
            Everything you need to manage your waitlist effectively and grow
            your audience
          </p>
        </div>
